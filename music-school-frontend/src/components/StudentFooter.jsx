        ...
        <div className="hidden md:grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li><a href="/" className="hover:text-slate-900 transition-colors font-medium"
              style={{
                fontFamily: "'Cinzel', serif"
              }}>Home</a></li>
              <li><a href="/workshops" className="hover:text-slate-900 transition-colors font-medium"
              style={{
                fontFamily: "'Cinzel', serif"
              }}>Workshops</a></li>
              <li><a href="/courses" className="hover:text-slate-900 transition-colors font-medium"
              style={{
                fontFamily: "'Cinzel', serif"
              }}>Courses</a></li>
              <li><a href="/teachers" className="hover:text-slate-900 transition-colors font-medium"
              style={{
                fontFamily: "'Cinzel', serif"
              }}>Meet the Teacher</a></li>
              <li><a href="/about" className="hover:text-slate-900 transition-colors font-medium"
              style={{
                fontFamily: "'Cinzel', serif"
              }}>About</a></li>
              <li><a href="/contact" className="hover:text-slate-900 transition-colors font-medium"
              style={{
                fontFamily: "'Cinzel', serif"
              }}>Contact Us</a></li>
            </ul>
